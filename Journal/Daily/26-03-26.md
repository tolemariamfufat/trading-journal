...
London open: "24074"
NY open:
9:30 Opening Range: 24189-23975
NDOG: 24184-24185
Yester Day High-Low: 24068-24355
Day EQ:
---
...
## 📝 Relative Strength/Weakness (SMT)

Before clicking "Sell" or "Buy" on an Order Block:
- [ ] **Check Correlation:** Look at EURUSD, GBPUSD, and the DXY.
- [ ] **Identify SMT:** Is one pair sweeping while the other is failing?
- [ ] **Select Asset:**
    - _Selling?_ Pick the one that **failed to sweep the High**.
    - _Buying?_ Pick the one that **failed to sweep the Low**.
- [ ] **Stop Loss Placement:** If I _must_ trade the pair that swept, my Stop Loss **must** be above the manipulation wick, not just the Order Block body.
